...
export default {
  ...
  components: { Toolbar, BottomBar, DataCreditsDialog, LangSettingsDialog, ViewSettingsDialog, PlanetsVisibility, SelectedObjectInfo, LocationDialog, ProgressBars, ObservingPanel }
}
</script>
