    ...
    <v-card-text style="height: 600px;">
      ...
      <p>Combination of the following catalogues:
        <ul class="data-credits">
          <li>Gaia DR2: <i>This work has made use of data from the European Space Agency (ESA) mission Gaia (<a href="https://www.cosmos.esa.int/gaia">https://www.cosmos.esa.int/gaia</a>), processed by the Gaia Data Processing and Analysis Consortium (DPAC, <a href="https://www.cosmos.esa.int/web/gaia/dpac/consortium">https://www.cosmos.esa.int/web/gaia/dpac/consortium</a>). Funding for the DPAC has been provided by national institutions, in particular the institutions participating in the Gaia Multilateral Agreement.</i>
          <br>Gaia Collaboration et al. (<a href="https://gea.esac.esa.int/archive/documentation/GDR2/bib.html#bib173">2016</a>): Description of the Gaia mission (spacecraft, instruments, survey and measurement principles, and operations)
          <br>Gaia Collaboration et al. (<a href="https://gea.esac.esa.int/archive/documentation/GDR2/bib.html#bib15">2018b</a>): Summary of the contents and survey properties.
          </li>
          ...
          <a href="http://cdsweb.u-strasbg.fr/ftp/cats/I/239">http://cdsweb.u-strasbg.fr/ftp/cats/I/239</a></li>
          <li>Brigh Stars Catalogue: Bright Star Catalogue, 5th Revised Ed. (Hoffleit+, 1991)<br>
          <a href="http://cdsarc.u-strasbg.fr/ftp/pub/cats/V/50/">http://cdsarc.u-strasbg.fr/ftp/pub/cats/V/50/</a></li>
        </ul>
      </p>
      <h3>Deep Sky Objects</h3>
      <p>Combination of the following catalogues:
        <ul class="data-credits">
          <li>HyperLeda database, <i>Makarov et al.</i> <a href="http://adsabs.harvard.edu/abs/2014A%26A...570A..13M">2014, A&A, 570, A13</a>: <a href="http://leda.univ-lyon1.fr">http://leda.univ-lyon1.fr</a>.</li>
          ...
          <a href="http://adsabs.harvard.edu/abs/2000A%26AS..143....9W">2000,A&AS,143,9</a>, "The SIMBAD astronomical database", Wenger et al.</li>
          <li>Open NGC Database: Mattia Verga <a href="https://github.com/mattiaverga/OpenNGC">https://github.com/mattiaverga/OpenNGC</a></li>
          <li>Caldwell Catalogue: <a href="https://fr.wikipedia.org/wiki/Liste_des_objets_de_Caldwell">from wikipedia</a></li>
      ...
      <h3>Planets Image</h3>
      <p>All images from NASA & JPL under public domain license: <a href="http://www.jpl.nasa.gov/images/policy/index.cfm">http://www.jpl.nasa.gov/images/policy/index.cfm</a></p>
      <p><br>
      </p>
      <h3>Minor Planets</h3>
      <p>All data comes from the IAU Minor Planet Center <a hreaf="https://www.minorplanetcenter.net/data">https://www.minorplanetcenter.net/data</a>. <i>This research has made use of data and/or services provided by the International Astronomical Union's Minor Planet Center.</i></p>
      <h3>Others</h3>
      <p>Landscape images by Fabien Chereau</p>
      <p>Constellation lines by Fabien Chereau</p>
      <p>All other graphics by Noctua Software</p>
    </v-card-text>
    <v-card-actions>
