...
static obj_klass_t circle_klass = {
    ...
    .attributes = (attribute_t[]) {
        ...
        PROPERTY(frame, TYPE_ENUM, .hint = "frame", MEMBER(circle_t, frame)),
        PROPERTY(orientation, TYPE_ANGLE, .hint = "d_angle",
                 MEMBER(circle_t, orientation)),
        PROPERTY(color, TYPE_COLOR, .hint = "color", MEMBER(circle_t, color)),
        PROPERTY(border_color, TYPE_COLOR, .hint = "color",
...
static obj_klass_t rect_klass = {
    ...
    .attributes = (attribute_t[]) {
        ...
        PROPERTY(frame, TYPE_ENUM, .hint = "frame", MEMBER(rect_t, frame)),
        PROPERTY(orientation, TYPE_ANGLE, .hint = "d_angle",
