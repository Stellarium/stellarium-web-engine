...
T( 1,11, 0, 0, "HI" ,   N_("HI (21cm) source"))
T( 1,12, 0, 0, "rB" ,   N_("radio Burst"))
T( 1,14, 0, 0, "Mas",   N_("Maser"))
T( 2, 0, 0, 0, "IR" , N_("Infra-Red source"))
T( 2, 2, 0, 0, "FIR",   N_("Far-IR source (λ >= 30 µm)"))
T( 2, 4, 0, 0, "NIR",   N_("Near-IR source (λ < 10 µm)"))
...
T( 9,11, 0, 0, "gLS",   N_("Gravitational Lens System (lens+images)"))
...
T(10,11, 0, 0, "**?",   N_("Physical Binary Candidate"))
T(10,11, 1, 0, "EB?",     N_("Eclipsing Binary Candidate"))
T(10,11,10, 0, "Sy?",     N_("Symbiotic Star Candidate"))
T(10,11,11, 0, "CV?",     N_("Cataclysmic Binary Candidate"))
T(10,11,11, 6, "No?",       N_("Nova Candidate"))
T(10,11,12, 0, "XB?",     N_("X-ray binary Candidate"))
T(10,11,12, 2, "LX?",       N_("Low-Mass X-ray binary Candidate"))
T(10,11,12, 3, "HX?",       N_("High-Mass X-ray binary Candidate"))
T(10,12, 0, 0, "Pec?",   N_("Possible Peculiar Star"))
T(10,12, 1, 0, "Y*?",     N_("Young Stellar Object Candidate"))
T(10,12, 2, 0, "pr?",     N_("Pre-main sequence Star Candidate"))
T(10,12, 2, 3, "TT?",       N_("T Tau star Candidate"))
...
T(10,12,14, 0, "AB?",     N_("Asymptotic Giant Branch Star candidate"))
T(10,12,14, 1, "LP?",       N_("Long Period Variable candidate"))
T(10,12,14, 2, "Mi?",       N_("Mira candidate"))
T(10,12,14, 3, "sv?",       N_("Semi-regular variable candidate"))
T(10,12,15, 0, "pA?",     N_("Post-AGB Star Candidate"))
T(10,12,16, 0, "BS?",     N_("Candidate blue Straggler Star"))
T(10,12,17, 0, "HS?",     N_("Hot subdwarf candidate"))
T(10,12,18, 0, "WD?",     N_("White Dwarf Candidate"))
T(10,12,20, 0, "N*?",     N_("Neutron Star Candidate"))
T(10,12,22, 0, "BH?",     N_("Black Hole Candidate"))
T(10,12,23, 0, "SN?",     N_("SuperNova Candidate"))
T(10,12,24, 0, "LM?",     N_("Low-mass star candidate"))
T(10,12,26, 0, "BD?",     N_("Brown Dwarf Candidate"))
...
T(12, 9, 0, 0, "C?*",   N_("Possible (open) star cluster"))
...
T(12,13, 1, 1, "Al*",       N_("Eclipsing binary of Algol type (detached)"))
T(12,13, 1, 2, "bL*",       N_("Eclipsing binary of beta Lyr type (semi-detached)"))
T(12,13, 1, 3, "WU*",       N_("Eclipsing binary of W UMa type (contact binary)"))
...
T(12,13,11, 2, "DQ*",       N_("CV DQ Her type (intermediate polar)"))
T(12,13,11, 3, "AM*",       N_("CV of AM Her type (polar)"))
...
T(13,12, 0, 0, "SR?",   N_("SuperNova Remnant Candidate"))
T(13,13, 0, 0, "SNR",   N_("SuperNova Remnant"))
T(13,14, 0, 0, "cir",   N_("CircumStellar matter"))
T(13,14, 1, 0, "of?",     N_("Outflow candidate"))
...
T(14, 6,12, 0, "AB*",     N_("Asymptotic Giant Branch Star (He-burning)"))
...
T(14, 6,15, 0, "pA*",     N_("Post-AGB Star (proto-PN)"))
T(14, 6,16, 0, "WD*",     N_("White Dwarf"))
T(14, 6,16, 1, "ZZ*",       N_("Pulsating White Dwarf"))
T(14, 6,17, 0, "LM*",     N_("Low-mass star (M<1solMass)"))
T(14, 6,18, 0, "BD*",     N_("Brown Dwarf (M<0.08solMass)"))
...
T(14, 9, 5, 9, "cC*",       N_("Classical Cepheid (delta Cep type)"))
T(14, 9, 5,10, "gD*",       N_("Variable Star of gamma Dor type"))
T(14, 9, 5,11, "SX*",       N_("Variable Star of SX Phe type (subdwarf)"))
...
T(14,14, 2, 0, "Pl?",     N_("Extra-solar Planet Candidate"))
...
T(15, 2, 2, 0, "BiC",     N_("Brightest galaxy in a Cluster (BCG)"))
...
T(16, 4, 0, 0, "Asa",   N_("Artifical Earth Satellite"))
...
T(16, 5, 2, 5, "ACo",     N_("Minor  Planet"))
